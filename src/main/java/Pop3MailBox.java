...
public class Pop3MailBox {
    ...
    public void batchReplayMessages(String ls_smtpHost, String ls_user, String ls_password, String ls_fromName, boolean ls_debugOn, String emailListFile) throws MessagingException, IOException {
